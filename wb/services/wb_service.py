...
def with_strategies(api_strategy=None, converter_strategy=None):
...
class WBService:
    ...
    @with_strategies(api_strategy=ReqOrdersStrategy, converter_strategy=ConvOrdersStrategy)
    ...
    @with_strategies(api_strategy=ReqSalesStrategy, converter_strategy=ConvSalesStrategy)
